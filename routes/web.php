...
Route::middleware('auth')->group(function () {
    ...
    Route::controller(PembeliController::class)->prefix('pembeli')->group(function () {
        ...
        Route::get('create', 'create')->name('pembeli.create');
        Route::post('store', 'store')->name('pembeli.store');
        Route::get('show/{id}', 'show')->name('pembeli.show');
        Route::get('edit/{id}', 'edit')->name('pembeli.edit');
        Route::put('edit/{id}', 'update')->name('pembeli.update');
        Route::delete('destroy/{id}', 'destroy')->name('pembeli.destroy');
    });
